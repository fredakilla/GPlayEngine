## gplayengine fork v1.0

- Reorder sources files by category.
- Drop support for visual studio and Xcode projects.
- Adds cmake support for Linux, Windows and Emscripten.
- Remove OpenGL and use BGFX api.
- Update shaders for bgfx support (WIP).
- Adds support for SDL2 and set as default platform.
- Adds support for SPARK particle engine.
- Adds new samples.
- Adds support for ImGui.
- Adds file watcher system for hot reloading.
- Adds event system.
- Adds shaders for deferred rendering.
