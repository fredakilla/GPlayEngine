...
/**
 * Displays a screen using the {@link gplay::Game::renderOnce} mechanism for at least the given amount
 ...
 * 
 * @param instance See {@link gplay::Game::renderOnce}.
 * @param method See {@link gplay::Game::renderOnce}.
 * @param cookie See {@link gplay::Game::renderOnce}.
 * @param time The minimum amount of time to display the screen (in milliseconds).
 */
