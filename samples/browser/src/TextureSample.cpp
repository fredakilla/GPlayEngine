...
{
    Material* material = model->setMaterial("res/core/shaders/forward/textured.vert", "res/core/shaders/forward/textured.frag");
...
void TextureSample::initialize()
{
    ...
    // Textured quad mesh
    {
        ...
        //_text.push_back(Text::create("res/core/ui/arial.gpb", "Quad: Textured", Rectangle(x, y, textWidth, fontSize), Vector4::one(), fontSize, Font::ALIGN_TOP_HCENTER, false));
    }
