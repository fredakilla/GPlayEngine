...
void BillboardSample::loadGround()
{
	...
	Effect* effect = Effect::createFromFile("res/core/shaders/forward/textured.vert", "res/core/shaders/forward/textured.frag", "TEXTURE_REPEAT");    
...
void BillboardSample::loadBillboards()
{
    ...
    Effect* effect = Effect::createFromFile("res/core/shaders/forward/textured.vert", "res/core/shaders/forward/textured.frag", "TEXTURE_DISCARD_ALPHA");
