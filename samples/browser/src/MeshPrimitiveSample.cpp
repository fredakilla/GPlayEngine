...
void MeshPrimitiveSample::initialize()
{
    ...
    _triangles->setMaterial("res/core/shaders/forward/colored.vert", "res/core/shaders/forward/colored.frag", "VERTEX_COLOR");
    ...
    Material* material = _triangleStrip->setMaterial("res/core/shaders/forward/colored.vert", "res/core/shaders/forward/colored.frag", "VERTEX_COLOR");
    ...
    _lineStrip->setMaterial("res/core/shaders/forward/colored.vert", "res/core/shaders/forward/colored.frag", "VERTEX_COLOR");
    
    Mesh* lineMesh = createLinesMesh();
    _lines = Model::create(lineMesh);
    SAFE_RELEASE(lineMesh);
    _lines->setMaterial("res/core/shaders/forward/colored.vert", "res/core/shaders/forward/colored.frag", "VERTEX_COLOR");
}
