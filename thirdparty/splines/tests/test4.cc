...
static valueType xx0[] = {  0,  1,  2,  3,  4,  5, 5,    6,  7,  8,  9, 10 } ;
static valueType yy0[] = { 10, 10, 10, 10, 10, 10, 10, 10.5, 15, 50, 60, 85 } ;

static valueType xx1[] = {  0,  1,  3,  4,  6,  7, 7,    9, 10, 12, 13, 15 } ;
static valueType yy1[] = { 10, 10, 10, 10, 10, 10, 10, 10.5, 15, 50, 60, 85 } ;

static valueType xx2[] = {  0,  2,  3,  5,  6,  8,  8,   9, 11, 12, 14, 15 } ;
static valueType yy2[] = { 10, 10, 10, 10, 10, 10, 10, 10.5, 15, 50, 60, 85 } ;

// RPN 14
static valueType xx3[] = { 7.99, 8.09,       8.19,       8.7,      8.7, 9.2,      10,       12,       15,       20       } ;
static valueType yy3[] = { 0,    2.76429e-5, 4.37498e-2, 0.169183, 0.169183, 0.469428, 0.943740, 0.998636, 0.999919, 0.999994 } ;

// Titanium
static valueType xx4[] = { 595,   635,   695,   795,   855,   875,   875, 895,   915,   935,   985,   1035,  1075  } ;
static valueType yy4[] = { 0.644, 0.652, 0.644, 0.694, 0.907, 1.336, 1.336, 2.169, 1.598, 0.916, 0.607, 0.603, 0.608 } ;

// toolpath
static valueType xx5[] = { 0.11, 0.12, 0.15, 0.16 } ;
static valueType yy5[] = { 0.0003, 0.0003, 0.0004, 0.0004 } ;

static sizeType  n[]   = { 11+1, 11+1, 11+1, 9+1, 12+1, 4 } ;
